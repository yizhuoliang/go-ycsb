...
import (
	...
	_ "github.com/yizhuoliang/go-ycsb/pkg/workload"
	"github.com/yizhuoliang/go-ycsb/pkg/ycsb"

	// Register basic database
	_ "github.com/yizhuoliang/go-ycsb/db/basic"
	// Register MySQL database
	_ "github.com/yizhuoliang/go-ycsb/db/mysql"
	// Register TiKV database
	_ "github.com/yizhuoliang/go-ycsb/db/tikv"
	// Register PostgreSQL database
	_ "github.com/yizhuoliang/go-ycsb/db/pg"
	// Register Aerospike database
	_ "github.com/yizhuoliang/go-ycsb/db/aerospike"
	// Register Badger database
	_ "github.com/yizhuoliang/go-ycsb/db/badger"
	// Register FoundationDB database
	_ "github.com/yizhuoliang/go-ycsb/db/foundationdb"
	// Register RocksDB database
	_ "github.com/yizhuoliang/go-ycsb/db/rocksdb"
	// Register Spanner database
	_ "github.com/yizhuoliang/go-ycsb/db/spanner"
	// Register pegasus database
	_ "github.com/yizhuoliang/go-ycsb/db/pegasus"
	// Register sqlite database
	_ "github.com/yizhuoliang/go-ycsb/db/sqlite"
	// Register cassandra database
	_ "github.com/yizhuoliang/go-ycsb/db/cassandra"
	// Register mongodb database
	_ "github.com/yizhuoliang/go-ycsb/db/mongodb"
	// Register redis database
	_ "github.com/yizhuoliang/go-ycsb/db/redis"
	// Register boltdb database
	_ "github.com/yizhuoliang/go-ycsb/db/boltdb"
	// Register minio
	_ "github.com/yizhuoliang/go-ycsb/db/minio"
	// Register elastic
	_ "github.com/yizhuoliang/go-ycsb/db/elasticsearch"
	// Register etcd
	_ "github.com/yizhuoliang/go-ycsb/db/etcd"
	// Register dynamodb
	_ "github.com/yizhuoliang/go-ycsb/db/dynamodb"
	// Register paxos
	_ "github.com/yizhuoliang/go-ycsb/db/paxos"
)
